        ...
        >
              ...
              return (
                ...
                >
                  ...
                  {item.id === 'reservations' && pendingCount > 0 && (
                    <Badge
                      variant="destructive"
                      className="!min-w-[22px] !h-[22px] !px-2 !py-0 !text-xs !rounded-full !flex !items-center !justify-center !border-2 !border-white/20"
                    >
                      {pendingCount}
                    </Badge>
                  )}
          ...
          <div className="p-4 border-t border-gray-800 space-y-2">
            <Button
              ...
              className="w-full justify-start text-gray-200 hover:text-white hover:bg-gray-800 py-4 text-base"
            >
            ...
            <button
              onClick={onClose}
              className="w-full px-4 py-4 rounded-lg text-gray-200 hover:bg-gray-800 hover:text-white transition-colors flex items-center gap-3 text-base"
            >
